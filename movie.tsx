...
export default function MovieBot({ title }: MovieBotProps) {
  ...
  return (
    <div className="relative w-full lg:w-1/2 lg:fixed lg:inset-0 lg:overflow-y-auto no-scrollbar bg-slate-900 flex flex-col justify-between">
      ...
      <div className="chat-box p-4 rounded-lg overflow-y-auto h-96 mt-auto no-scrollbar">
      ...
      <div className="flex justify-between p-4 pt-0">
        ...
        <button className="flex-1 btn bg-green-600 text-white hover:bg-gray-700 rounded-md p-4 mx-1 text-center text-lg">
          RESTART
        </button>
